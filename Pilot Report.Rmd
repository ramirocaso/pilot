...
I'm going to present the analysis in this HTML, which I hope doesn't become too long. We can discuss it further in our next meeting.
...
This reduces the data set to a total of `r nrow(exp_data)` observations. 
...
Lastly, I want to see if there are differences in the average subjective knowledge reported in Time 2 (after the experimental stimui was presented) controlling for the score of av_sk_t1 and pilot. 
...
As I said before, I believe that the stimuli is not working as predicted. 
Presenting participants with explanatory text. regardless of the type of text, seems to increase participant's perceive understanding of how metabolism work. 

When you think about it, this makes sense. 

Participants have no reason to feel their SK threatened in any way, because their knowledge has not been tested yet. They probably think they now know more, since they have just acquired additional information. This effect is shown in the significant differences of SK between T1 and T2. Also, and perhaps more importantly, the difference between T2 and T3 is also significant, but in the opposite direction, meaning that after participants were asked to answer the Objective Knowledge Scale their perceived understanding suffered. 

Finally, when the information is presented as an extended apt metaphor it appears to have a greater effect on SK than when it is presented with a non-apt extended metaphor. This effect is very mild, but it could indicate that apt metaphors are better at increasing SK relative to non-apt metaphors. 

# What to do next?

I believe we need to find a better way to shatter the illusion of knowing. Instead of using a Objective Knowledge scale, we could ask participants to explain, in their own words, what they've just read. Doing so will probably be difficult, specially for the literal condition. Therefore, we could expect a higher drop of SK from T2 to T3 in the literal and non-apt metaphors conditions. 
